...
function app({ Component, pageProps,router }) {
  ...
  return (
    ...
    <div className="grid grid-cols-12 gap-6 px-2 my-14 lg:mb-10 md:mb-16 sm:px-10 md:px-24 xl:px-20 lg:px-36">
      <div className="h-full col-span-12 p-4 text-base text-center bg-white dark:text-white lg:col-span-3 rounded-2xl dark:bg-dark-200 shadow-custom-light dark:shadow-custom-dark">
        <Sidebar/>
      </div>
